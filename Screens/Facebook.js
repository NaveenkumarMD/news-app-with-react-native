...
const Logo=()=><Ionicons size={24} color="dodgerblue" name="md-logo-facebook"/>
const statusbarheight=StatusBar.currentHeight
function Facebook({navigation}) {
    const [data,setdata]=useState([{author:'naveen'}])
    const [sortby,setsortby]=useState('')
    useEffect(()=>{
        const response=fetch(`https://newsapi.org/v2/everything?q=${"Facebook"}&from=2021-03-27&sortBy=publishedAt&apiKey=159badcbcb0647ed9e3721a55db9bef4&language=en`)
    ...
    return (
        <View>
            ...
            <Ionicons size={200} color="dodgerblue" name="md-logo-facebook"/>
                </View>
